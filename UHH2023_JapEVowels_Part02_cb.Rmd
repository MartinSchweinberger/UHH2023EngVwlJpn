...
ame <- base::readRDS(url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/reference/GenAm.txt", "rb")) %>%
...
bre <-base::readRDS(url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/reference/SSB.txt", "rb")) %>%
  dplyr::mutate(label = dplyr::case_when(item == "had" ~ "{",
                                         item == "heed" ~ "i:",
                                         item == "hid" ~ "I",
                                         item == "head" ~ "e",
