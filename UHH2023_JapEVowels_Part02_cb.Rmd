...
# load .rda data
vdf  <- base::readRDS(file = url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/vdf.rda", "rb")) %>%
...
bio <- base::readRDS(url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/biodata_icnale.rda", "rb")) %>%
...
ame <- base::readRDS(url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/reference/GenAm.rda", "rb")) %>%
...
bre <-base::readRDS(url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/reference/SSB.rda", "rb")) %>%
  dplyr::mutate(label = dplyr::case_when(item == "had" ~ "{",
                                         item == "heed" ~ "i:",
                                         item == "hid" ~ "I",
                                         item == "head" ~ "e",
...
```{r data, message=F, warning=F}
# load .rda data
fdat  <- base::readRDS(file = url("https://github.com/MartinSchweinberger/UHH2023EngVwlJpn/raw/main/data/fdat_sst.rda", "rb"))
# inspect
nrow(fdat); head(fdat)
```
